...
import { getAllUsers, getfollowing, getUser, updateUser } from "../../api/users";
import { isLoggedIn } from "../../helpers/authHelper";
import CommentBrowser from "../CommentBrowser";

import ErrorAlert from "../ErrorAlert";
import FindUsers from "../FindUsers";
import FollowFollowers from "../FollowFollowers";
...
const ProfileView = () => {
  ...
  const userfollowing = JSON.parse(localStorage.getItem("following"))
  ...
  const fetchUsers = async() => {
    ...
    setUsers(temp.filter((user) => userfollowing.includes(user._id)))
